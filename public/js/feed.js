                ...
                if(result[i].isPublic === true){
                    ...
                    fill = `
                        ...
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-lock mr-2" width="22" height="22" viewBox="0 0 24 24" stroke-width="1.5" stroke="#646464" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
